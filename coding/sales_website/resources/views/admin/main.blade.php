...
<head>
	...
	<!-- CSS Files -->
	<link href="{{asset('resources/css/material-dashboard.minf066.css?v=2.1.0')}}" rel="stylesheet" />
	<!-- CSS Just for demo purpose, don't include it in your project -->
	<link href="{{asset('resources/demo/demo.css')}}" rel="stylesheet" />
...
<body class="">
	<!-- Extra details for Live View on GitHub Pages -->
	<div class="wrapper ">
		<div class="sidebar" data-color="rose" data-background-color="black" data-image="{{asset('public/img/sidebar-1.jpg')}}">
			<!--
			...
			<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="#pablo">@yield('breackcum')</a>
					</div>
	...
	<script src="{{asset('resources/js/core/bootstrap-material-design.min.js')}}"></script>
	...
	<script src="{{asset('resources/js/plugins/fullcalendar.min.js')}}"></script>
	...
	<script src="{{asset('resources/js/core-js/2.4.1/core.js')}}"></script>
	<!-- Library for adding dinamically elements -->
	<script src="{{asset('resources/js/plugins/arrive.min.js')}}"></script>
	<!--  Google Maps Plugin    -->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB2Yno10-YTnLjjn_Vtk0V8cdcY5lC4plU"></script>
	<!-- Place this tag in your head or just before your close body tag. -->
	<script async defer src="{{asset('resources/js/plugins/buttons.js')}}"></script>
	<!-- Chartist JS -->
	...
	<script src="{{asset('resources/js/material-dashboard.minf066.js?v=2.1.0')}}" type="text/javascript"></script>
	<!-- Material Dashboard DEMO methods, don't include it in your project! -->
	<script src="{{asset('resources/demo/demo.js')}}"></script>
	<script>
